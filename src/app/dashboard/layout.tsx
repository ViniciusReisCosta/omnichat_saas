...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  const { user, loading, isAuthenticated, hasActiveAccess, logout } = useAuth();
  ...
  useEffect(() => {
    ...
    if (!loading && isAuthenticated && !hasActiveAccess) router.push('/billing');
  }, [loading, isAuthenticated, hasActiveAccess, router]);
